 ...
 */
NS_MSG_BASE bool NS_MsgStripRE(const char **stringP, uint32_t *lengthP, nsCString & modifiedSubject);
                                       ...
                                       nsIInterfaceRequestor **result)
{
    ...
    return mailews::MsgNewInterfaceRequestorAggregation(callbacks, cbs, result);
}
