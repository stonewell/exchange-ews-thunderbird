...
#ifndef MsgDBFolderBase_h__
#define MsgDBFolderBase_h__
...
class NS_MSG_BASE MsgDBFolderBase: public nsRDFResource,
...
// This class is a kludge to allow MsgKeySet to be used with uint32_t keys
class MsgKeySetU
{
public:
    // Creates an empty set.
  static MsgKeySetU* Create();
  ~MsgKeySetU();
