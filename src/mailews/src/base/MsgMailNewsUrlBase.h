...
#ifndef MsgMailNewsUrlBase_h___
#define MsgMailNewsUrlBase_h___
...
class NS_MSG_BASE MsgMailNewsUrlBase : public nsIMsgMailNewsUrl
{
public:
    MsgMailNewsUrlBase();
