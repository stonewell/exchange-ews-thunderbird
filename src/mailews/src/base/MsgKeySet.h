...
#ifndef _MsgKeySet_H_
#define _MsgKeySet_H_

#include "msgCore.h"
#include "nsTArray.h"

// MsgKeySet represents a set of articles.  Typically, it is the set of
...
class NS_MSG_BASE MsgKeySet {
public:
  // Creates an empty set.
  static MsgKeySet* Create(/* MSG_NewsHost* host = NULL*/);

  // Creates a set from the list of numbers, as might be found in a
  // newsrc file.
  static MsgKeySet* Create(const char* str/* , MSG_NewsHost* host = NULL*/);
  ~MsgKeySet();
...
protected:
  MsgKeySet(/* MSG_NewsHost* host */);
  MsgKeySet(const char* /* , MSG_NewsHost* host */);
  bool Grow();
  bool Optimize();
