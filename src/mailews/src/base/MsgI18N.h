 ...
 */
//NS_MSG_BASE char      *MsgI18NEncodeMimePartIIStr(const char *header, bool structured, const char *charset, int32_t fieldnamelen, bool usemime);
 ...
 */
NS_MSG_BASE bool      MsgI18Nstateful_charset(const char *charset);
 ...
 */
NS_MSG_BASE bool MsgI18Nmultibyte_charset(const char *charset);
 ...
 */
NS_MSG_BASE bool      MsgI18Ncheck_data_in_charset_range(const char *charset, const char16_t* inString,
 ...
 */
NS_MSG_BASE const char * MsgI18NFileSystemCharset(void);
 ...
 */
NS_MSG_BASE void MsgI18NTextFileCharset(nsACString& aCharset);
 ...
 * @return            nsresult.
 */
NS_MSG_BASE nsresult MsgI18NConvertFromUnicode(const char* aCharset,
 ...
 * @return            nsresult.
 */
NS_MSG_BASE nsresult MsgI18NConvertToUnicode(const char* aCharset,
 ...
 */
NS_MSG_BASE const char *MsgI18NParseMetaCharset(nsIFile* file);
 ...
 * @return            nsresult.
 */
NS_MSG_BASE nsresult MsgI18NSaveAsCharset(const char* contentType, const char* charset, 
 ...
 * @return           nsresult
 */
NS_MSG_BASE nsresult MsgI18NShrinkUTF8Str(const nsCString &inString,
                                            uint32_t aMaxLength,
                                            nsACString &outString);
 ...
 */
NS_MSG_BASE void MsgI18NConvertRawBytesToUTF16(const nsCString& inString, 
                                                 const char* charset,
                                                 nsAString& outString);
 ...
 */
NS_MSG_BASE void MsgI18NConvertRawBytesToUTF8(const nsCString& inString, 
                                                const char* charset,
                                                nsACString& outString);
...
{
    return MsgI18NConvertFromUnicode("x-imap4-modified-utf7", aSrc,
                                       aDest, true);
}

inline nsresult CopyMUTF7toUTF16(const nsCString& aSrc, nsAString& aDest)
{
    return MsgI18NConvertToUnicode("x-imap4-modified-utf7", aSrc,
                                     aDest, true);
}
...
{
    return MsgI18NConvertToUnicode(charset, aSrc, aDest);
}

inline nsresult ConvertToUnicode(const char* charset,
                                 const char* aSrc, nsAString& aDest)
{
    return MsgI18NConvertToUnicode(charset, nsDependentCString(aSrc), aDest);
}

inline nsresult ConvertFromUnicode(const char* charset,
                                   const nsString &aSrc, nsACString& aDest)
{
    return MsgI18NConvertFromUnicode(charset, aSrc, aDest);
}

inline void ConvertRawBytesToUTF16(const nsCString& inString, 
                                   const char* charset, nsAString& outString)
{
    return MsgI18NConvertRawBytesToUTF16(inString, charset, outString);
}

inline void ConvertRawBytesToUTF16(const char* inString, 
                                   const char* charset, nsAString& outString)
{
    return MsgI18NConvertRawBytesToUTF16(nsDependentCString(inString),
                                           charset,
                                           outString);
}
...
{
    return MsgI18NConvertRawBytesToUTF8(inString, charset, outString);
}
