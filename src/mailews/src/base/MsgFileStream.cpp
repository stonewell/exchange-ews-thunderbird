...
NS_IMPL_ISUPPORTS(MsgFileStream, nsIInputStream, nsIOutputStream, nsISeekableStream)

nsresult MsgFileStream::InitWithFile(nsIFile *file)
{
...
/* void close (); */
NS_IMETHODIMP MsgFileStream::Close()
{
  nsresult rv = NS_OK;
...
NS_IMETHODIMP MsgFileStream::ReadSegments(nsWriteSegmentFun aWriter, void * aClosure, uint32_t aCount, uint32_t *_retval)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isNonBlocking (); */
NS_IMETHODIMP MsgFileStream::IsNonBlocking(bool *aNonBlocking)
{
  *aNonBlocking = false;
  return NS_OK;
}
...
NS_IMETHODIMP
MsgFileStream::WriteFrom(nsIInputStream *inStr, uint32_t count, uint32_t *_retval)
{
...
NS_IMETHODIMP
MsgFileStream::WriteSegments(nsReadSegmentFun reader, void * closure, uint32_t count, uint32_t *_retval)
{
