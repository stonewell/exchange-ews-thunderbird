...
#ifndef MsgIncomingServerBase_h__
#define MsgIncomingServerBase_h__
...
class NS_MSG_BASE MsgIncomingServerBase : public nsIMsgIncomingServer,
                                        public nsSupportsWeakReference
{
 public:
  MsgIncomingServerBase();

  NS_DECL_THREADSAFE_ISUPPORTS
  NS_DECL_NSIMSGINCOMINGSERVER

protected:
  virtual ~MsgIncomingServerBase();
...
#endif // MsgIncomingServerBase_h__
