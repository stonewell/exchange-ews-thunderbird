...
#ifndef MsgProtocolBase_h__
#define MsgProtocolBase_h__
...
class NS_MSG_BASE MsgProtocolBase : public nsIStreamListener
                                , public nsIChannel
                                , public nsITransportEventSink
{
public:
  MsgProtocolBase(nsIURI * aURL);
