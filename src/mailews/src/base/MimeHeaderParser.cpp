...
/* Need to copy these files from thunderbird source tree
 * when we built on a new version thunderbird
 */
#ifdef _WIN32
#include "nsUnicharUtils.cpp"
#include "nsUnicodeProperties.cpp"
#endif
