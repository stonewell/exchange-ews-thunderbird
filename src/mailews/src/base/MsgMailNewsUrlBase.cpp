...
MsgMailNewsUrlBase::MsgMailNewsUrlBase()
{
...
NS_IMPL_ISUPPORTS(MsgMailNewsUrlBase, nsIMsgMailNewsUrl, nsIURL, nsIURI)

////////////////////////////////////////////////////////////////////////////////////
// Begin nsIMsgMailNewsUrl specific support
////////////////////////////////////////////////////////////////////////////////////

nsresult MsgMailNewsUrlBase::GetUrlState(bool * aRunningUrl)
{
  if (aRunningUrl)
...
nsresult MsgMailNewsUrlBase::SetUrlState(bool aRunningUrl, nsresult aExitCode)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::RegisterListener(nsIUrlListener *aUrlListener)
{
...
nsresult MsgMailNewsUrlBase::UnRegisterListener(nsIUrlListener *aUrlListener)
{
  NS_ENSURE_ARG_POINTER(aUrlListener);
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetServer(nsIMsgIncomingServer ** aIncomingServer)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetMsgWindow(nsIMsgWindow *aMsgWindow)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetStatusFeedback(nsIMsgStatusFeedback *aMsgFeedback)
{
  if (aMsgFeedback)
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetMaxProgress(int64_t *aMaxProgress)
{
  *aMaxProgress = mMaxProgress;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetMaxProgress(int64_t aMaxProgress)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetUpdatingFolder(bool *aResult)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetUpdatingFolder(bool updatingFolder)
{
  m_updatingFolder = updatingFolder;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetAddToMemoryCache(bool *aAddToCache)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetAddToMemoryCache(bool aAddToCache)
{
  m_addContentToCache = aAddToCache;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetMsgIsInLocalCache(bool *aMsgIsInLocalCache)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetMsgIsInLocalCache(bool aMsgIsInLocalCache)
{
  m_msgIsInLocalCache = aMsgIsInLocalCache;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetSuppressErrorMsgs(bool *aSuppressErrorMsgs)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetSuppressErrorMsgs(bool aSuppressErrorMsgs)
{
  m_suppressErrorMsgs = aSuppressErrorMsgs;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::IsUrlType(uint32_t type, bool *isType)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetSearchSession(nsIMsgSearchSession *aSearchSession)
{
  if (aSearchSession)
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetSearchSession(nsIMsgSearchSession **aSearchSession)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetSpec(nsACString &aSpec)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetSpec(const nsACString &aSpec)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetPrePath(nsACString &aPrePath)
{
  return m_baseURL->GetPrePath(aPrePath);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetScheme(nsACString &aScheme)
{
  return m_baseURL->GetScheme(aScheme);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetScheme(const nsACString &aScheme)
{
  return m_baseURL->SetScheme(aScheme);
}


NS_IMETHODIMP MsgMailNewsUrlBase::GetUserPass(nsACString &aUserPass)
{
  return m_baseURL->GetUserPass(aUserPass);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetUserPass(const nsACString &aUserPass)
{
  return m_baseURL->SetUserPass(aUserPass);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetUsername(nsACString &aUsername)
{
  /* note:  this will return an escaped string */
  return m_baseURL->GetUsername(aUsername);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetUsername(const nsACString &aUsername)
{
  return m_baseURL->SetUsername(aUsername);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetPassword(nsACString &aPassword)
{
  return m_baseURL->GetPassword(aPassword);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetPassword(const nsACString &aPassword)
{
  return m_baseURL->SetPassword(aPassword);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetHostPort(nsACString &aHostPort)
{
  return m_baseURL->GetHostPort(aHostPort);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetHostPort(const nsACString &aHostPort)
{
  return m_baseURL->SetHostPort(aHostPort);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetHost(nsACString &aHost)
{
  return m_baseURL->GetHost(aHost);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetHost(const nsACString &aHost)
{
  return m_baseURL->SetHost(aHost);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetPort(int32_t *aPort)
{
  return m_baseURL->GetPort(aPort);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetPort(int32_t aPort)
{
  return m_baseURL->SetPort(aPort);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetPath(nsACString &aPath)
{
  return m_baseURL->GetPath(aPath);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetPath(const nsACString &aPath)
{
  return m_baseURL->SetPath(aPath);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetAsciiHost(nsACString &aHostA)
{
    return m_baseURL->GetAsciiHost(aHostA);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetAsciiSpec(nsACString &aSpecA)
{
    return m_baseURL->GetAsciiSpec(aSpecA);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetOriginCharset(nsACString &aOriginCharset)
{
    return m_baseURL->GetOriginCharset(aOriginCharset);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetBaseURI(nsIURI **aBaseURI)
{
  NS_ENSURE_ARG_POINTER(aBaseURI);
  return m_baseURL->QueryInterface(NS_GET_IID(nsIURI), (void**) aBaseURI);
}

NS_IMETHODIMP MsgMailNewsUrlBase::Equals(nsIURI *other, bool *_retval)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::EqualsExceptRef(nsIURI *other, bool *result)
{
  // The passed-in URI might be a mail news url. Pass our inner URL to its
  // Equals method. The other mail news url will then pass its inner URL to
  // to the Equals method of our inner URL. Other URIs will return false.
...
NS_IMETHODIMP
MsgMailNewsUrlBase::CloneIgnoringRef(nsIURI** result)
{
...
NS_IMETHODIMP
MsgMailNewsUrlBase::GetSpecIgnoringRef(nsACString &result)
{
  return m_baseURL->GetSpecIgnoringRef(result);
}

NS_IMETHODIMP
MsgMailNewsUrlBase::GetHasRef(bool *result)
{
  return m_baseURL->GetHasRef(result);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SchemeIs(const char *aScheme, bool *_retval)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::Resolve(const nsACString &relativePath, nsACString &result) 
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetDirectory(nsACString &aDirectory)
{
  return m_baseURL->GetDirectory(aDirectory);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetDirectory(const nsACString &aDirectory)
{

  return m_baseURL->SetDirectory(aDirectory);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetFileName(nsACString &aFileName)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetFileBaseName(nsACString &aFileBaseName)
{
  return m_baseURL->GetFileBaseName(aFileBaseName);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetFileBaseName(const nsACString &aFileBaseName)
{
  return m_baseURL->SetFileBaseName(aFileBaseName);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetFileExtension(nsACString &aFileExtension)
{
  if (!mAttachmentFileName.IsEmpty())
  {
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetFileExtension(const nsACString &aFileExtension)
{
  return m_baseURL->SetFileExtension(aFileExtension);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetFileName(const nsACString &aFileName)
{
  mAttachmentFileName = aFileName;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetQuery(nsACString &aQuery)
{
  return m_baseURL->GetQuery(aQuery);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetQuery(const nsACString &aQuery)
{
  return m_baseURL->SetQuery(aQuery);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetRef(nsACString &aRef)
{
  return m_baseURL->GetRef(aRef);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetRef(const nsACString &aRef)
{
  return m_baseURL->SetRef(aRef);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetFilePath(nsACString &o_DirFile)
{
  return m_baseURL->GetFilePath(o_DirFile);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetFilePath(const nsACString &i_DirFile)
{
  return m_baseURL->SetFilePath(i_DirFile);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetCommonBaseSpec(nsIURI *uri2, nsACString &result)
{
  return m_baseURL->GetCommonBaseSpec(uri2, result);
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetRelativeSpec(nsIURI *uri2, nsACString &result)
{
  return m_baseURL->GetRelativeSpec(uri2, result);
}

NS_IMETHODIMP MsgMailNewsUrlBase::SetMemCacheEntry(nsICacheEntryDescriptor *memCacheEntry)
{
  m_memCacheEntry = memCacheEntry;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase:: GetMemCacheEntry(nsICacheEntryDescriptor **memCacheEntry)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetImageCacheSession(nsICacheSession *imageCacheSession)
{
  m_imageCacheSession = imageCacheSession;
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetImageCacheSession(nsICacheSession **imageCacheSession)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::CacheCacheEntry(nsICacheEntryDescriptor *cacheEntry)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::RemoveCacheEntry(nsICacheEntryDescriptor *cacheEntry)
{
  m_cachedMemCacheEntries.RemoveObject(cacheEntry);
  return NS_OK;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetMimeHeaders(nsIMimeHeaders * *mimeHeaders)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetMimeHeaders(nsIMimeHeaders *mimeHeaders)
{
...
nsresult nsMsgSaveAsListener::SetupMsgWriteStream(nsIFile *aFile, bool addDummyEnvelope)
{
  ...
  nsresult rv = mailews::MsgNewBufferedFileOutputStream(getter_AddRefs(m_outputStream),
                                               aFile, -1, 0666);
  NS_ENSURE_SUCCESS(rv, rv);
...
NS_IMETHODIMP MsgMailNewsUrlBase::GetSaveAsListener(bool addDummyEnvelope, 
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetFolder(nsIMsgFolder * /* aFolder */)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetFolder(nsIMsgFolder ** /* aFolder */)
{
  return NS_ERROR_NOT_IMPLEMENTED;
}

NS_IMETHODIMP MsgMailNewsUrlBase::GetMsgHeaderSink(nsIMsgHeaderSink * *aMsgHdrSink)
{
...
NS_IMETHODIMP MsgMailNewsUrlBase::SetMsgHeaderSink(nsIMsgHeaderSink * aMsgHdrSink)
{
